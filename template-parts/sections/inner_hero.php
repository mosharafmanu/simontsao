...
$title_classes      = 'mg-md text-lg-center hero-title hero-title-scale inner-hero__title';
$summary_classes    = 'mg-md hero-summary hero-summary-surface inner-hero__summary';
$content_has_summary = ! empty( $hero_summary );

if ( $show_title_surface ) {
	$title_classes .= ' hero-title-surface';
}

if ( $show_title_surface && ! $content_has_summary ) {
...
<div class="<?php echo esc_attr( $hero_classes ); ?>"<?php echo $style_rules ? ' style="' . esc_attr( implode( ';', $style_rules ) ) . '"' : ''; ?>>
	...
	<div class="container bloc-xxl bloc-lg-lg inner-hero__container">
		<div class="row">
			<div class="col">
				<?php if ( $hero_title ) : ?>
					<h1 class="<?php echo esc_attr( $title_classes ); ?>"><?php echo wp_kses_post( $hero_title ); ?></h1>
				<?php endif; ?>
